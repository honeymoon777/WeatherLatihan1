...
package com.example.weatherapilatihan1.model;
...
public class Main implements Parcelable
{
     ...
     * @param tempMin
     */
    public Main(Integer temp, Double feelsLike, Double tempMin, Double tempMax, Integer pressure, Integer humidity, Integer seaLevel, Integer grndLevel) {
        super();
        this.temp = temp;
